...
@property (strong, nonatomic) SKLabelNode *currentOperatorNode;
...
@property  NSInteger jumperValue;
@property  short consecutiveTraps;
@property  NSInteger currentOperatorValue;
@property short equationType;
